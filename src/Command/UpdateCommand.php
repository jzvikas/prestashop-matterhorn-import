...
{
    public function __construct(private SourceInterface $source, private UpdateStage $stage, private ImportLock $lock, private OperationalSettings $settings) { parent::__construct('matterhornimport:update'); }
