...
schemaCheck(substr_count($install, 'CREATE TABLE IF NOT EXISTS') === 13, 'core schema must define 13 skeleton tables');
...
schemaCheck(str_contains($installer, "'install.sql', 'attribute-mapping.sql'"), 'installer must load both canonical schema files');
