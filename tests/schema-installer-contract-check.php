...
$legacyTableToken = 'PREFIX_lp_' . 'import_';
...
schemaCheck(!str_contains($install, $legacyTableToken), 'generic skeleton table token must not leak into core schema');
schemaCheck(!str_contains($attributeInstall, $legacyTableToken), 'generic skeleton table token must not leak into attribute schema');
schemaCheck(!str_contains($imageOrphanInstall, $legacyTableToken), 'generic skeleton table token must not leak into image orphan schema');
